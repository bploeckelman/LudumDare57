 ...
 * <br>
 * NOTE(brian): This class uses {@link ByteBuffer} to read the Aseprite file, which is not supported by the web backend
 *  (at least not GWT, haven't tested TeaVM). It has been moved to the lwjgl3 package to avoid breaking the web build.
 *  It should be possible to run this as a build step similar to what we're doing with the sprite packer gradle task,
 *  but before that can be done we have to extract the {@link SpriteInfo} type, which encapsulates the parsed data
 *  from an Aseprite file, and make it available in the {@code core} module. It should probably be extracted to it's
 *  own class and renamed to {@code AseSpriteInfo} or something like that.
 */
public class Aseprite {
    ...
    public enum Modes {
        ...
        public static Modes fromValue(int value) {
            Modes modes;
            switch (value) {
                case 1: modes = indexed;   break;
                case 2: modes = grayscale; break;
                case 4: modes = rgba;      break;
    ...
    public enum Chunks {
        ...
        public static Chunks fromValue(int value) {
            Chunks chunks;
            switch (value) {
                case 0x0004: chunks = OldPaletteA;  break;
                case 0x0011: chunks = OldPaletteB;  break;
                case 0x2004: chunks = Layer;        break;
                case 0x2005: chunks = Cel;          break;
                case 0x2006: chunks = CelExtra;     break;
                case 0x2007: chunks = ColorProfile; break;
                case 0x2016: chunks = Mask;         break;
                case 0x2017: chunks = Path;         break;
                case 0x2018: chunks = FrameTags;    break;
                case 0x2019: chunks = Palette;      break;
                case 0x2020: chunks = UserData;     break;
                case 0x2022: chunks = Slice;        break;
    ...
    public enum LoopDirections {
        ...
        public static LoopDirections fromValue(int value) {
            ...
            switch (value) {
                case 0: loopDirections = Forward;  break;
                case 1: loopDirections = Reverse;  break;
                case 2: loopDirections = PingPong; break;
    ...
    public enum LayerTypes {
        ...
        public static LayerTypes fromValue(int value) {
            ...
            switch (value) {
                case 0: layerTypes = Normal; break;
                case 1: layerTypes = Group;  break;
    ...
    private static PointI4 extract_hitbox_data(Aseprite aseprite, SpriteInfo info, Frame frame) {
        ...
        int pivot_y = 0;
        int slice_h = 0;
        var slice = aseprite.slices.isEmpty() ? null : aseprite.slices.get(0);
        if (slice != null) {
